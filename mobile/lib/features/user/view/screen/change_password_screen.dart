            ...
            child: Column(children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: colorConstants.fastStyle(
                            16, FontWeight.w600, const Color(0xff29292A)),
                      ),
                    ],
                  ),
                ),
              ...
              Container(
                  ...
                  child: BlocBuilder<ChangePasswordBloc, ChangePasswordState>(
                    ...
                    if (state.status == ProgressStatus.notAuthenticated ||
                      ...
                      return Column(
                        children: [
                          Text(
                            ...
                            style: colorConstants.fastStyle(
                                20, FontWeight.w700, const Color(0xff333334)),
                          ),
                          const SizedBox(
                            height: 30,
                          ),
                          ...
                          ElevatedButton(
                            ...
                            child: Text(
                              'Tiếp tục',
                              style: colorConstants.fastStyle(
                                  16, FontWeight.w700, const Color(0xffFFFFFF)),
                            ),
                          ),
                        ],
                      );
                    ...
                    return Column(
                      children: [
                        ...
                        Text(
                          ...
                          style: colorConstants.fastStyle(
                              14, FontWeight.w500, const Color(0xff666667)),
                        ),
                        const SizedBox(
                          height: 30,
                        ),
                          ...
                          return Column(
                            children: [
                              CustomTextField(
                                ...
                                hasBorder: true,
                                validator: (value) {
                                  if (state.passwordStatus == PasswordStatus.sameAsOld ||
